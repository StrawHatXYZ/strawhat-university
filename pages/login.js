...
export default function Signin() {
	...
	const { login, user, gLogin } = useAuth();
					...
					<form className="space-y-4 md:space-y-6 " action="#">
						...
						<button
							...
							className="w-full text-white
							 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-3 text-center bg-primary-500 hover:bg-primary-700 focus:ring-indigo-300"
						>
							Sign in
						</button>
						<button
							...
							className="w-full text-white flex justify-center 
							 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-3 text-center bg-primary-500 hover:bg-primary-700 focus:ring-indigo-300"
						>
							<FcGoogle size={20} className="mr-2" /> Login
						</button>
