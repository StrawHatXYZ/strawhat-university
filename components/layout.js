...
export default function Layout({ children }) {
  ...
  return (
    <div class="flex">
      <aside class="h-screen sticky top-0 bg-white w-full md:w-72">
            ...
            <div className="flex flex-col justify-between h-full">
              ...
              <div>
                <li className="my-3 border-t border-secondary-500" key="logout">
                  <Link
                    href="/logout"
                    className={`flex px-6 py-4 items-center rounded  hover:bg-primary-100 hover:text-secondary-700 cursor-pointer ${
